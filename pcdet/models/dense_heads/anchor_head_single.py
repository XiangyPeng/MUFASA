...
class AnchorHeadSingle(AnchorHeadTemplate):
    ...
    def forward(self, data_dict):
        spatial_features_2d = data_dict['spatial_features_2d'] # spatial_features_2d 维度 ：（batch_size, 384, 248, 216）
        ...
        cls_preds = cls_preds.permute(0, 2, 3, 1).contiguous()  # [N, H, W, C] --> (batch_size, 200, 176, 18) 类别放在最后一维
        box_preds = box_preds.permute(0, 2, 3, 1).contiguous()  # [N, H, W, C] --> (batch_size ,200, 176, 42) 预测参数放在最后一维
